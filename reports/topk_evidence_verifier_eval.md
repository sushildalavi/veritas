...
- top1/top3/top5 all improve macro_f1 over the previous retrieved-evidence bundle baseline of 0.420 from `reports/oracle_vs_retrieved_v2.json`, but remain well below the 0.55 target and far below the oracle macro_f1 of 0.705.
