...
- Training command: `python scripts/train_verifier_clean.py`

| split | examples | accuracy | macro_f1 |
| --- | --- | --- | --- |
| train | 2808 | 0.825 | 0.819 |
| validation | 649 | 0.447 | 0.438 |
| test | 642 | 0.484 | 0.482 |

## Test set per-class metrics

| label | precision | recall | f1 | support |
| --- | --- | --- | --- | --- |
| SUPPORTED | 0.439 | 0.558 | 0.491 | 224 |
| REFUTED | 0.409 | 0.379 | 0.394 | 195 |
| NOT_ENOUGH_INFO | 0.636 | 0.502 | 0.561 | 223 |
...
| SUPPORTED | 125 | 68 | 31 |
| REFUTED | 88 | 74 | 33 |
| NOT_ENOUGH_INFO | 72 | 39 | 112 |

## Threshold check

- macro_f1 >= 0.55: FAIL (0.482)
- accuracy >= 0.60: FAIL (0.484)
...
| 172301 | Scream 2 is a slasher film. | Scream 2 is a 1997 American slasher film directed by Wes Craven and written by Kevin Williamson. | SUPPORTED | REFUTED |
| 51260 | Robinson Crusoe on Mars was a Greek tragedy. | Robinson Crusoe on Mars is a 1964 American science fiction film directed by Byron Haskin and produced by Aubrey Schenck that stars Paul Mantee, Victor Lundin, and Adam West. | REFUTED | SUPPORTED |
