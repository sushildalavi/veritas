...
class VerificationPipeline:
    ...
    optional_research_embedding_model: str | None = None
    reranker_backend: str = "none"
    cross_encoder_model: str | None = None
    explanation_mode: str = "template"
    mlx_lora_model: str | None = None
    mlx_lora_adapter: str | None = None
...
def load_pipeline(
    ...
    *,
    ...
    return VerificationPipeline(
        ...
        optional_research_embedding_model=settings.optional_research_embedding_model,
        ...
        mlx_lora_model=settings.mlx_lora_model,
        mlx_lora_adapter=settings.mlx_lora_adapter,
        strict_json_output=settings.strict_json_output,
        max_candidates_for_reranking=settings.max_candidates_for_reranking,
